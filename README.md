...
This dapp-dex is built on [react-moralis](https://github.com/MoralisWeb3/react-moralis) and [Moralis](https://moralis.io?utm_source=github&utm_medium=readme&utm_campaign=ethereum-boilerplate). Also has its own context provider for quick access to `chainId` or `ethAddress`
...
📄 Clone or fork `dapp-dex`:

```sh
git clone https://github.com/Deepak-Perla/dapp-dex.git
```
...
💱 `<DEX />` : interface for [Moralis 1Inch Plugin](https://moralis.io/plugins/1inch?utm_source=github&utm_medium=readme&utm_campaign=). This plugin integrates the DeFi / DEX aggregator 1Inch to any project that uses Moralis.
